(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_cb5dbd._.js", {
            ...
            const fetchBlogs = {
                "BlogSection.useEffect.fetchBlogs": async ()=>{
                    try {
                        ...
                        const transformedBlogs = data.map({
                            "BlogSection.useEffect.fetchBlogs.transformedBlogs": (blog)=>({
                                    ...blog,
                                    image: blog.image.startsWith('http') ? blog.image : `/uploads/${blog.image}`
                                })
                        }["BlogSection.useEffect.fetchBlogs.transformedBlogs"]);
...
"[project]/components/specialtyTours.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function TopDestinations() {
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/components/specialtyTours.jsx",
            lineNumber: 47,
            columnNumber: 12
        }, this);
    }
...
//# sourceMappingURL=_cb5dbd._.js.map